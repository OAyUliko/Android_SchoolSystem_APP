...
/*        FloatingActionButton fab = findViewById(R.id.fab);
        ...
        //这里好像无所谓id的正确与否， 但就是要这几个id才能显示侧边栏？？
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.person_information, R.id.score, R.id.evaluate)
    ...
    public void setInformation()
    {
        ...
        Name.setText("你好呀 "+intent.getStringExtra("teacher_name"));
        Major_Class.setText(intent.getStringExtra("teacher_majorname"));
    }
