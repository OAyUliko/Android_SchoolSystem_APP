package com.example.android_student_system.teacher.ui.person_information;
...
import com.example.android_student_system.student.ui.person_information.person_informationViewModel;
...
public class person_informationFragment extends Fragment {
    ...
    private String[] left = {"学院",  "性别", "身份证号"};
    private int[] icons = {R.drawable.major, R.drawable.sex, R.drawable.selfid};
    View root;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Name.setText(intent.getStringExtra("teacher_name"));
        No.setText(intent.getIntExtra("teacher_no",0)+"");

        ChangePass.setOnClickListener(new OnClickListenerChange());
        getno=intent.getIntExtra("teacher_no",0);
    }
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            String[] right = {intent.getStringExtra("teacher_majorname"), intent.getStringExtra("teacher_sex"), intent.getStringExtra("teacher_id")};
